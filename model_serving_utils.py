...
# Initialize workspace client with credentials from environment
def _get_workspace_client():
    """Get WorkspaceClient configured with credentials from environment."""
    ...
    if workspace_url and client_id and client_secret:
        ...
        # Fall back to default auth (will use DATABRICKS_HOST if set)
        return WorkspaceClient()
